// app/src/main/java/com/prog7314/arcticflow/data/PartCatalog.kt
package com.prog7314.arcticflow.data

/**
 * Single source of truth for the parts catalogue used by both
 * CreateQuoteScreen and CreateJobCardScreen. Keeping it here prevents the
